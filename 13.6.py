# Вывод списка последовательности чисел
...
# D результате получаем 538, вместо 500. Что на это повлияло? Последнее число меньше 500, и надо прибавить еще одно
# число. Результат больше 500 цикл прекращается.
...
# Пример 2  Дана двумерная матрица 3x3. Определите максимум и минимум каждой строки, а также их индексы
# random_matrix = [
#    [9, 2, 1],
#    [2, 5, 3],
#    [4, 8, 5]
